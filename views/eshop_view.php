...
<iframe src="<?php echo $SHAREYOURCART_API; ?>/button?client_id=<?php echo urlencode($client_id); ?>&callback_url=<?php echo urlencode(bloginfo('wpurl').'/wp-admin/admin-ajax.php?&action=shareyourcart_eshop&'.(isset($product_id) ? 'p='.$product_id : null)) ?>&skin=<?php echo $button_skin;  ?>&orientation=<?php echo $button_position;?>" <?php if($use_iframe) echo 'class="button_iframe"';else echo 'class="button_iframe-normal"';?>frameBorder="0" scrolling="no"></iframe>
